...
export const POWERUP_ICONS: Record<PowerUpKind, string> = {
  ...
  strike:
    '<path d="M8 44L48 12" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><path d="M14 20l10-6M32 44l12-8" stroke="currentColor" stroke-width="1.6" opacity=".45"/>',
  blotter:
